...
Заявка без куратора через 36 часов отправляется в личные сообщения всех администраторов с датой/временем выдачи, полным составом и кнопками ответа. Если все отказались, в канал приходит предложение отклонить заявку с упоминанием старших. Молчание и недоставленное сообщение не считаются отказом. Старший может отклонить заявку до выдачи с обязательной причиной.
